...
(() => {
  ...
  const CSS = `
    .shop-marquee{display:block;position:relative;background:linear-gradient(90deg,rgba(0,255,136,.05) 0%,rgba(0,255,136,.12) 50%,rgba(0,255,136,.05) 100%);border-bottom:1px solid rgba(0,255,136,.25);overflow:hidden;white-space:nowrap;cursor:pointer;height:26px;line-height:26px;transition:background .25s}
    ...
    .shop-mq-item{display:inline-block;padding:0 14px;color:#00ff88;font-family:"JetBrains Mono","Fira Code",ui-monospace,monospace;font-size:11px;font-weight:600;letter-spacing:.4px;text-shadow:0 0 4px rgba(0,255,136,.35);white-space:nowrap}
    .shop-mq-sep{display:inline-block;padding:0 6px;color:rgba(0,255,136,.35);font-size:13px}
      ...
      m.innerHTML = `
        <div class="shop-mq-track">
          ${Array.from({ length: 2 }).map(() => `
            ...
            <span class="shop-mq-sep">·</span>
            <span class="shop-mq-item">📡 BAKCELL · AZERCELL · NAR</span>
            <span class="shop-mq-sep">·</span>
